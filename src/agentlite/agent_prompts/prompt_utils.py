...
PROMPT_TOKENS = {
    ...
    "action_experience": {"begin": "[Action_Experience]", "end": "[End of Action_Experience]"},
...
DEFAULT_PROMPT = {
    "agent_instruction": f"""You are an intelligent agent. You should follow your {PROMPT_TOKENS["role"]['begin']}, {PROMPT_TOKENS["action"]['begin']} to take actions. Your generation should follow the example format and can only generate only one action in each step. Finish the task as best as you can.""",
