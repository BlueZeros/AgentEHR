...
MODEL="qwen3_30b_moe"
VLLM_SERVER=(
    # "http://192.168.186.133:4000" 
    # "http://192.168.186.133:4001"
    "http://192.168.186.133:4002"
    "http://192.168.186.133:4003"
    "http://192.168.186.133:4004"
    "http://192.168.186.133:4005"
    "http://192.168.186.133:4006"
    "http://192.168.186.133:4007"
)
MCP_SERVER=(
...
EXP_NAME=${METHOD}_rollout${NUM_RUNS}_think_new_w_memory
...
MEMORY_PATH="/sfs/rhome/liaoyusheng/data/Datasets/EHRAgent/results/train/qwen3_30b_moe"
MEMORY_EXP_NAME="mcp_retrosum_rollout1_think_new"
MEMORY_TASKS=(
    "diagnoses_ccs_100" 
    "labevents_100" 
...
for i in "${!TASKS[@]}"; do
    ...
    memory_task="${MEMORY_TASKS[$i]}"
    MEMORY_SAVE_PATH=${MEMORY_PATH}/${memory_task}/${MEMORY_EXP_NAME}
